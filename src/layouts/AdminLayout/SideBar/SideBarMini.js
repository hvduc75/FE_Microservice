...
function SideBarMini({ isPagesMenuOpen, setIsPagesMenuOpen, isSideMenuOpen, setIsSideMenuOpen }) {
    const closeSideMenu = () => {
            ...
            <div className="py-4 text-gray-500 dark:text-gray-400">
                ...
                <ul className="mt-6">
                    <li className="relative px-6 py-3">
                        ...
                        ></span>
                        <a
                            className="inline-flex items-center w-full text-sm text-gray-800 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-100"
                            href="index.html"
                        >
                            <svg
                                className="w-5 h-5"
                ...
                <ul>
                    ...
                    <li className="relative px-6 py-3" onClick={() => setIsPagesMenuOpen(!isPagesMenuOpen)}>
                        <button className="inline-flex items-center justify-between w-full text-sm transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
