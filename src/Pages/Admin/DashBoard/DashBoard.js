...
function DashBoard(props) {
    ...
    useEffect(() => {
        // Lấy danh sách thông báo lần đầu khi Dashboard load
        const fetchNotifications = async () => {
            try {
                const res = await getNotifications();
                if (res && res.data && res.data.DT) {
                    setNotifications(res.data.DT);
                }
            } catch (err) {
        ...
        // Lắng nghe realtime notification
        ...
        <>
            ...
            <div className="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
                ...
                <div className="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                    ...
                    <div>
                        <p className="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400">Total events</p>
                ...
                <div className="flex items-center p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
                    ...
                    <div>
                        <p className="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400">Events of the day</p>
